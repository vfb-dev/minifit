...
urlpatterns = [
    ...
    path("template-sets/<int:pk>/edit/", views.template_set_update, name="template_set_update"),
    path("template-sets/<int:pk>/delete/", views.template_set_delete, name="template_set_delete"),
